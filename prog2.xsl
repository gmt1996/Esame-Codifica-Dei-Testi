    ...
    <xsl:template match="/">
        <html>
           ...
           <xsl:element name="div">
               ...
               <div id="buttons">
                   <select id="pulsanti">
                       <option id="p187" class="Cartolina"  value="Cart1" selected="selected">019</option>
                       <option id="p067" class="Cartolina"  value="Cart2">071</option>
                       <option id="p197" class="Cartolina"  value="Cart3">083</option>
                   </select>
