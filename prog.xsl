    ...
    <xsl:template match="/">
        <html>
           ...
           <xsl:element name="div">
               ...
               <div id="buttons">
                   <select id="pulsanti">
                       <option id="p019" class="Cartolina"  value="Cart1" selected="selected">019</option>
                       <option id="p071" class="Cartolina"  value="Cart2">071</option>
                       <option id="p083" class="Cartolina"  value="Cart3">083</option>
                   </select>
                        ...
                        <xsl:for-each select="//tei:surface[position()=2]/tei:graphic">
                            <xsl:element name="div">
                                ...
                                <xsl:element name="div">
                                    ...
                                    <xsl:element name="img">
                                        <xsl:attribute name="src"><xsl:value-of select="@url"/></xsl:attribute>
                                        <xsl:attribute name="id"><xsl:value-of select="translate(@url, 'cartoline/.jpg', 'C')"/></xsl:attribute>
                                        <xsl:attribute name="class">Img</xsl:attribute>
                                        <xsl:choose>
                                            <xsl:when test="@url='cartoline/7694-019R.jpg'">
                                                <xsl:attribute name="usemap">#Map</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="@url='cartoline/7694-071R.jpg'">
                                                <xsl:attribute name="usemap">#Map2</xsl:attribute>
                                            </xsl:when>
                                            <xsl:when test="@url='cartoline/7694-083R.jpg'">
